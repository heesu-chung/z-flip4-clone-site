...
css와 styled-components 역시 바닐라 JS와 프레임워크와 비슷하게, 절대 우위가 아닌 각자의 장점이 있습니다. styled-components의 경우 프레임워크 개발 환경에서 CSS-in-JS를 가능케 하기에 VueJS와 비슷한 개발 환경에서 작업이 가능하다는 장점이 있습니다. 하지만 별도 라이브러리 설치에 따른 비용이 들기에 서비스 용도에 맞게 사용해야합니다. 인터랙션 요소가 많은 해당 프로젝트에서는 성능적 측면을 고려하여 scss를 사용하였습니다.  
