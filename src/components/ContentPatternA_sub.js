...
const ContentPatternA_sub = ({
    ...
    useEffect(() => {
        if (screenX < 1024 && leftBtn && rightBtn && contents) {
            if (scroll === 0) {
    ...
    return (
        <section className="content-a content-excellence" id="design">
...
export default ContentPatternA_sub;
